	...
	return (
		<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-900 to-blue-500 py-12 px-4 sm:px-6 lg:px-8">
			<div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-4 shadow-xl">
				<div>
					<img src="../../public/loogo.png" alt="" className="h-20 w-36 z-50 m-auto"/>
					<h2 className="mt-4 text-center text-2xl font-extrabold text-gray-900">Register</h2>
				</div>
				<form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
					...
					/>
					{errors.username && <span className="text-sm text-red-500">{errors.uaername?.message}</span>}
