...
const Navbar = () => {
	...
	return (
		<nav className="flex flex-col items-center justify-between gap-2 bg-green-300 px-4 py-3 drop-shadow-lg lg:flex-row lg:justify-start sm:px-8">
			<div className="flex w-full flex-row justify-between lg:w-fit">
				<button className="flex flex-row items-center gap-2" onClick={() => navigate('/')}>
					...
					<img src="../../public/loogo.png" alt="" className="h-12 w-24 z-50" />
					<h1 className="mr-12 text-xl text-black">Cinema</h1>
				</button>
				<button
